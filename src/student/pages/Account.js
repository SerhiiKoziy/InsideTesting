...

                            {
                                ...
                                (!this.props.profile.didInvalidate && !this.props.profile.isFetching )) ?
                                    ...
                                    (    <div className="updata-form-wr">
                                        ...
                                        {
                                            this.state.editorView && (
                                                <EditProfile title="Ваші дані" description="" onSubmit={::this.submitEdit}
                                                             autoComplete="off"
                                                             key="step1">
                                                            ...
                                                            <div>
                                                                {
                                                                    (this.state.hasShopChecked == false && !this.state.hasCompanyChecked) && (
                                                                        <Field
                                                                            name="shopId"
                                                                            component={renderDropdownList}
                                                                            //data= {companies[companyId].shops}
                                        ...
                                        }
                                        {
                                            this.state.currentTab === 3 && (
                                                <div className="third-tab">
                                                    ...
                                                    <p className="summResult"><span>Усього</span> <span>{scoreMain.testScore + ((scoreMain.samsungPlusScore == null)? 0 : scoreMain.samsungPlusScore)}</span></p>
                                                </div>
                                            )
