    ...
    render() {
        ...
        return(
            <div className="page buy-present">
                ...
                {
                    this.state.page == 3 && account.resultBuying === true && account.isSendProductShop == true && (
                ...
                {
                    this.state.page == 3 && account.resultBuying === 'too_expensive' && account.isSendProductShop == true && (
                        <div className="thankYouPage">
                ...
                {
                    this.state.page == 3 && account.resultBuying === 'unavailable' && account.isSendProductShop == true && (
                        <div className="thankYouPage">
                ...
                {
                    this.state.page == 3 && account.resultBuying === 'invalid' && account.isSendProductShop == true  && (
                        <div className="thankYouPage">
                            <h3 >Щось пішло не так, спробуте спочатку.</h3>
                ...
                {
                    (this.state.page == 3 && account.isSendProductShop == false )&&(
                        <Spinner></Spinner>
                    )
                }
