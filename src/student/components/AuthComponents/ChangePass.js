...
const WizardStepRestorePassword = (props) => {
...
WizardStepRestorePassword.propTypes = {
    title: PropTypes.string,
    description: PropTypes.string
};

WizardStepRestorePassword.defaultProps = {
    title: 'title',
...
export default reduxForm({
    form: 'RestoreForm',              // <------ same form name
    destroyOnUnmount: false,     // <--- --- preserve form data
    validate,
})(WizardStepRestorePassword)
